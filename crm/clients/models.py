...
# claude — Phase 2c: Client is now person-only. Company data (name/NIP/type)
# lives on Company via company_links; the old Client.company_name/company_nip/
# client_type columns were backfilled into Company (migration 0007) and dropped.
