from safedelete.signals import post_softdelete # сигнал который срабатывает после удаления 
from crm.status_manager.services.status_service import update_parent, delete_request
